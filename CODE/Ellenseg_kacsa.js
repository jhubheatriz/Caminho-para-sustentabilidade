function Ellenseg_kacsa() {
  ...
  this.ki = true;
  this.kep = [];
  this.kep[1] = loadImage("carrofumaça.png");
  this.kep[2] = loadImage("carrofumaça.png");
  this.kep[3] = loadImage("carrofumaça.png");
  this.kep[4] = loadImage("carrofumaça.png");
  this.kep[5] = loadImage("carrofumaça.png");
