function Grafika() {
  ...
  this.p_kf = loadImage("nuvemfumaca.png");
  this.p_kozf = loadImage("nuvemfumaca1.png");
  this.p_nf = loadImage("nuvemfumaca2.png");
  this.p_kdb = loadImage("gramapoluida.png");
  this.p_ndb = loadImage("gramapoluida1.png");
  this.p_kb = loadImage("gramapoluida2.png");
  this.p_kozb = loadImage("gramapoluida3.png");
  this.p_nb = loadImage("gramapoluida4.png");
  this.penz = loadImage("armoney.png");
