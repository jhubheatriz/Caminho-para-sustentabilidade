function Talaj_fal() {
  ...
  this.p_kcs = loadImage("chamine.png");
  this.p_kozcs = loadImage("chamine1.png");
  this.p_ncs = loadImage("chamine2.png");
  this.p_kerd = loadImage("kerd.png");
  this.p_t = loadImage("blocos.png");
  this.p_l = loadImage("latalixo.png");
  this.p_padlo = loadImage("terra.png");
  this.p_kerdu = loadImage("kerd_utve.png");
  this.p_kerds = loadImage("kerd_s.png");
  this.ptt = loadImage("blocos.png");
